...
export class Kibana extends pulumi.CustomResource {
  ...
  declare public readonly spec: pulumi.Output<outputs.kibana.v1.KibanaSpec>;
  declare public readonly /*out*/ status: pulumi.Output<outputs.kibana.v1.KibanaStatus>;
  ...
  constructor(
    ...
    const aliasOpts = {
      aliases: [
        ...
        { type: 'kubernetes:kibana.k8s.elastic.co/v1beta1:Kibana' },
      ],
    };
...
export interface KibanaArgs {
  ...
  spec?: pulumi.Input<inputs.kibana.v1.KibanaSpec | undefined>;
}
