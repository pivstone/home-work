...
export class Elasticsearch extends pulumi.CustomResource {
  ...
  declare public readonly spec: pulumi.Output<outputs.elasticsearch.v1.ElasticsearchSpec>;
  declare public readonly /*out*/ status: pulumi.Output<outputs.elasticsearch.v1.ElasticsearchStatus>;
...
export interface ElasticsearchArgs {
  ...
  spec?: pulumi.Input<inputs.elasticsearch.v1.ElasticsearchSpec | undefined>;
}
