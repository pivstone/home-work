...
export class Elasticsearch extends pulumi.CustomResource {
  ...
  public static readonly __pulumiType =
    'kubernetes:elasticsearch.k8s.elastic.co/v1beta1:Elasticsearch';
  ...
  declare public readonly spec: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchSpec>;
  declare public readonly /*out*/ status: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchStatus>;
  ...
  constructor(
    ...
    const aliasOpts = {
      aliases: [
        ...
        {
          type: 'kubernetes:elasticsearch.k8s.elastic.co/v1alpha1:Elasticsearch',
        },
      ],
    };
...
export interface ElasticsearchArgs {
  ...
  spec?: pulumi.Input<
    inputs.elasticsearch.v1beta1.ElasticsearchSpec | undefined
  >;
}
