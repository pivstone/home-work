...
export class ElasticsearchList extends pulumi.CustomResource {
  ...
  public static readonly __pulumiType =
    'kubernetes:elasticsearch.k8s.elastic.co/v1beta1:ElasticsearchList';
  ...
  declare public readonly items: pulumi.Output<
    outputs.elasticsearch.v1beta1.Elasticsearch[]
  >;
  /**
...
export interface ElasticsearchListArgs {
   ...
   */
  items: pulumi.Input<
    pulumi.Input<inputs.elasticsearch.v1beta1.Elasticsearch>[]
  >;
  /**
   * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   */
