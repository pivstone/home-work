...
export class StackConfigPolicyList extends pulumi.CustomResource {
  ...
  public static get(
    ...
    return new StackConfigPolicyList(name, undefined as any, {
      ...opts,
      id: id,
    });
  }
  ...
  public static readonly __pulumiType =
    'kubernetes:stackconfigpolicy.k8s.elastic.co/v1alpha1:StackConfigPolicyList';
  ...
  declare public readonly items: pulumi.Output<
    outputs.stackconfigpolicy.v1alpha1.StackConfigPolicy[]
  >;
  /**
   * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   */
  declare public readonly kind: pulumi.Output<'StackConfigPolicyList'>;
  /**
  ...
  constructor(
    name: string,
    args?: StackConfigPolicyListArgs,
    opts?: pulumi.CustomResourceOptions,
  ) {
...
export interface StackConfigPolicyListArgs {
   ...
   */
  items: pulumi.Input<
    pulumi.Input<inputs.stackconfigpolicy.v1alpha1.StackConfigPolicy>[]
  >;
  /**
   * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   */
  kind?: pulumi.Input<'StackConfigPolicyList' | undefined>;
  /**
   * Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   */
